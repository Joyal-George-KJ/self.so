          ...
          <div className="flex-1 flex flex-col md:flex-row max-w-4xl mx-auto items-center px-5 md:px-2 py-8 md:pt-0">
            ...
            <div className="w-full md:w-1/2 max-w-[378px] flex flex-col justify-center items-center md:items-start ">
              <div className="max-w-md text-center md:text-left">
                <div className="inline-block font-mono gap-2.5 px-2.5 py-1.5 rounded dark:bg-gray-900 dark:text-gray-300 bg-gray-100 text-sm mb-5 text-design-gray">
                  100% free & open source
                </div>

                <h1 className="text-[32px] font-bold mb-4 flex items-center justify-center md:justify-start gap-4 flex-wrap text-design-black dark:text-design-white font-mono leading-4">
                  <span>LinkedIn</span>
                  <img
                    src="/right-arrow.png"
                ...
                <div className="relative flex flex-col items-center font-mono w-full md:w-fit">
                  <Link href="/upload">
                    <Button className="relative group flex items-center dark:bg-design-white bg-design-black hover:bg-design-black/95 text-white dark:text-black px-6 py-3 h-auto text-base overflow-hidden">
